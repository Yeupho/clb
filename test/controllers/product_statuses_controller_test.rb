...
class ProductStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_status" do
    assert_difference('ProductStatus.count') do
      post product_statuses_url, params: { product_status: { Description: @product_status.Description } }
    end
  ...
  test "should update product_status" do
    patch product_status_url(@product_status), params: { product_status: { Description: @product_status.Description } }
