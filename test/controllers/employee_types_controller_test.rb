...
class EmployeeTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_type" do
    assert_difference('EmployeeType.count') do
      post employee_types_url, params: { employee_type: { EmpTypeName: @employee_type.EmpTypeName } }
    end
  ...
  test "should update employee_type" do
    patch employee_type_url(@employee_type), params: { employee_type: { EmpTypeName: @employee_type.EmpTypeName } }
